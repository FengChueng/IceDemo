...
final class _AMD_OrderService_addOrder extends IceInternal.IncomingAsync implements AMD_OrderService_addOrder
{
    public _AMD_OrderService_addOrder(IceInternal.Incoming in)
    {
        super(in);
    }
