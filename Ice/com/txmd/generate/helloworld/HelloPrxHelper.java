...
{
    private static final String __helloWorld_name = "helloWorld";

    public String helloWorld(String name)
    {
        return helloWorld(name, null, false);
    }

    public String helloWorld(String name, java.util.Map<String, String> __ctx)
    {
        return helloWorld(name, __ctx, true);
    }

    private String helloWorld(String name, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        __checkTwowayOnly(__helloWorld_name);
        return end_helloWorld(begin_helloWorld(name, __ctx, __explicitCtx, true, null));
    }

    public Ice.AsyncResult begin_helloWorld(String name)
    {
        return begin_helloWorld(name, null, false, false, null);
    }

    public Ice.AsyncResult begin_helloWorld(String name, java.util.Map<String, String> __ctx)
    {
        return begin_helloWorld(name, __ctx, true, false, null);
    }

    public Ice.AsyncResult begin_helloWorld(String name, Ice.Callback __cb)
    {
        return begin_helloWorld(name, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_helloWorld(String name, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_helloWorld(name, __ctx, true, false, __cb);
    }

    public Ice.AsyncResult begin_helloWorld(String name, Callback_Hello_helloWorld __cb)
    {
        return begin_helloWorld(name, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_helloWorld(String name, java.util.Map<String, String> __ctx, Callback_Hello_helloWorld __cb)
    {
        return begin_helloWorld(name, __ctx, true, false, __cb);
    }
    ...
    {
        return begin_helloWorld(name, null, false, false, __responseCb, __exceptionCb, null);
    }
    ...
    {
        return begin_helloWorld(name, null, false, false, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    public Ice.AsyncResult begin_helloWorld(String name, 
                                            ...
                                            IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_helloWorld(name, __ctx, true, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_helloWorld(String name, 
                                            ...
                                            IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_helloWorld(name, __ctx, true, false, __responseCb, __exceptionCb, __sentCb);
    }

    private Ice.AsyncResult begin_helloWorld(String name, 
                                             java.util.Map<String, String> __ctx, 
                                             ...
                                             IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_helloWorld(name, __ctx, __explicitCtx, __synchronous, 
                                new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                    {
                                        public final void __completed(Ice.AsyncResult __result)
                                        {
                                            HelloPrxHelper.__helloWorld_completed(this, __result);
                                        }
                                    });
    }
    ...
    {
        __checkAsyncTwowayOnly(__helloWorld_name);
        IceInternal.OutgoingAsync __result = getOutgoingAsync(__helloWorld_name, __cb);
        try
        {
            __result.prepare(__helloWorld_name, Ice.OperationMode.Idempotent, __ctx, __explicitCtx, __synchronous);
    ...
    public String end_helloWorld(Ice.AsyncResult __iresult)
    {
        IceInternal.OutgoingAsync __result = IceInternal.OutgoingAsync.check(__iresult, this, __helloWorld_name);
        try
        {
            if(!__result.__wait())
            {
    ...
    static public void __helloWorld_completed(Ice.TwowayCallbackArg1<String> __cb, Ice.AsyncResult __result)
    {
        com.txmd.generate.helloworld.HelloPrx __proxy = (com.txmd.generate.helloworld.HelloPrx)__result.getProxy();
        String __ret = null;
        try
        {
