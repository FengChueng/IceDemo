...
public final class ClockPrxHelper extends Ice.ObjectPrxHelperBase implements ClockPrx
{
    ...
    {
        return begin_tick(time, null, false, false, __responseCb, __exceptionCb, null);
    }
    ...
    {
        return begin_tick(time, null, false, false, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    public Ice.AsyncResult begin_tick(String time, 
                                      ...
                                      IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_tick(time, __ctx, true, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_tick(String time, 
                                      ...
                                      IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_tick(time, __ctx, true, false, __responseCb, __exceptionCb, __sentCb);
    }

    private Ice.AsyncResult begin_tick(String time, 
                                       java.util.Map<String, String> __ctx, 
    ...
    {
        IceInternal.OutgoingAsync __result = getOutgoingAsync(__tick_name, __cb);
        try
        {
            __result.prepare(__tick_name, Ice.OperationMode.Normal, __ctx, __explicitCtx, __synchronous);
    ...
    public void end_tick(Ice.AsyncResult __iresult)
    {
        __end(__iresult, __tick_name);
    }
